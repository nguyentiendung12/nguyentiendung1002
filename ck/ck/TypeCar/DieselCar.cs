...
{
    internal class DieselCar : Car, Refillable
    {
        ...
        public DieselCar(Wheel wheel, Engine engine, CarColor color, string gearBox, string modelCar, float maxTankVolume, float fuleTankVolume, string recommentGas)
        {
            this.wheel = wheel;
            this.engine = engine;
            this.color = color;
        ...
        public object Clone()
        {
            DieselCar car = (DieselCar)this.MemberwiseClone();
